package com.betterofficelife.ninetosix.wheel.widget;
...
public class WheelView extends View {
	/** Scrolling duration */
	private static final int SCROLLING_DURATION = 0;
	...
	/** Text size */
	public static int TEXT_SIZE = 180;
	

	/** Top and bottom items offset (to hide that) */
	public static final int ITEM_OFFSET = TEXT_SIZE / 5;
